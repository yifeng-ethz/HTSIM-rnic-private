...
std::unique_ptr<FatTreeTopologyCfg> makeSlingshotTopologyConfig(const RnicAtlahsCliOptions& options,
                                                                std::uint32_t physical_node_count) {
...
std::string renderRnicAtlahsModelManifest(const RnicAtlahsCliOptions& options,
    ...
    const std::optional<std::string>& state_trace_csv = spec.profile == RnicProfile::SlingshotLike
                                                            ? options.slingshot.state_trace_csv
                                                            : options.collective.state_trace_csv;
