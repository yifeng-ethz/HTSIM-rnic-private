...
public:
    ...
    // DATA.  The endpoint runtime owns the strict-priority queue and calls
    // this at a packet boundary before dispatchOpportunity().  Control does
    // not consume a PRBS DATA opportunity.
